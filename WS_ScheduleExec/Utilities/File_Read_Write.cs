...
namespace WS_CloneDataLive
{
    ...
    {
        public static string path = AppDomain.CurrentDomain.BaseDirectory + @"Log\" + DateTime.Now.ToString("yyyy-MM-dd") + ".log";
        ...
        public static void Write_File(string path, string Content, bool append)
        {
            Check_Exits(path);
            try
            {
        ...
        public static void Write_File(string Content, bool append)
        {
            Check_Exits(path);
            try
            {
